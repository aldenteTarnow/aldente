...
const ingredients = [
    ...
    {name: 'swieza papryka', img: pepper},
    {name: 'boczek', img: bacon},
    {name: 'kielbasa', img: sausage},
    {name: 'brokuly', img: brocoli},
    {name: 'ser gorgonzola', img: gorgonzola},
    {name: 'tunczyk', img: tuna},
    ...
    {name: 'mieso gyros', img: gyros},
    {name: 'oscypek wedzony', img: oscypek},
    {name: 'ogorek kiszony', img: cucumber},
    {name: 'rukola', img: rucola},
    {name: 'salami pikantne', img: salami},
    {name: 'szynka parmenska', img: parmenska},
    {name: 'duszone pieczarki', img: mushrooms},
    {name: 'losos wedzony', img: salmon},
